    ...
    $.fn.fullpage = function(options) {
        ...
        */
        function createInfiniteSections(v){
            ...
            // Recalculate animation variables.less
        ...
        * Some variables.less such as `autoScrolling` or `recordHistory` might change automatically its state when using `responsive` or `autoScrolling:false`.
